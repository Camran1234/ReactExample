...
CREATE TABLE IF NOT EXISTS `mydb`.`carrito` (
  ...
  `cantidad` INT NOT NULL,
  `precio` INT NOT NULL,
  `lista_solicitud_pedido_idlista_solicitud_pedido` INT NOT NULL,
  `idusuario` INT NOT NULL,
  PRIMARY KEY (`idcarrito`),
  INDEX `fk_carrito_lista_solicitud_pedido1_idx` (`lista_solicitud_pedido_idlista_solicitud_pedido` ASC) VISIBLE,
  CONSTRAINT `fk_carrito_lista_solicitud_pedido1`
    FOREIGN KEY (`lista_solicitud_pedido_idlista_solicitud_pedido`)
    REFERENCES `mydb`.`lista_solicitud_pedido` (`idlista_solicitud_pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`oferta` (
  `idProducto` INT NOT NULL AUTO_INCREMENT,
  `productoOferta` INT NOT NULL,  
  PRIMARY KEY (`idProducto`),
  INDEX `fk_oferta_idProducto_producto_idx` (`idProducto` ASC) VISIBLE,
  CONSTRAINT `fk_oferta_idProducto_producto`
    FOREIGN KEY (`idProducto`)
    REFERENCES `mydb`.`producto` (`idProducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  INDEX `fk_oferta_productoOferta_producto_idx` (`productoOferta` ASC) VISIBLE,
  CONSTRAINT `fk_oferta_productoOferta_producto`
    FOREIGN KEY (`productoOferta`)
    REFERENCES `mydb`.`producto` (`idProducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
INSERT INTO empresa
  (nombre, estado)
  VALUES ('Don Camaron', 1);

INSERT INTO empresa
  (nombre, estado)
  VALUES ('Farmacia Cruz Verde', 1);
...
INSERT INTO producto 
  ...
  empresa_idEmpresa, descripcion, oferta)
...
-------INSERTS pedido-----------
INSERT INTO pedido
  (idlista_solicitud_pedido, idProducto, cantidad, precio)
  VALUES(1, 1, 4, 505.6);

INSERT INTO pedido
  (idlista_solicitud_pedido, idProducto, cantidad, precio)
  VALUES(1, 2, 7, 1747.55);
